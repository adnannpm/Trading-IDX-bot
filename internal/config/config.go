...
// Load membaca ulang variabel lingkungan dan memperbarui cache konfigurasi.
func Load() *Config {
	configLock.Lock()
...
// Get mengembalikan konfigurasi saat ini dari environment.
func Get() *Config {
	return Load()
}

// GetRoleForTier mengembalikan role ID berdasarkan nama tier plan.
...
// LoadEnv membaca file key-value seperti .env dan menetapkannya ke environment jika belum ada.
